...
<template>
  <b-container class="bv-example-row">
    ...
    <div v-for="(item, id) in items" :key="item"><div>
    ...
    <b-card bg-variant="light" border-variant="secondary">
      ...
      <h4><b><v-card-title v-text="item.Titulo"/></b></h4>
        <b-button v-b-modal.[`example-modal-${item}`] variant="primary">Click para leer</b-button>
    ...
    <b-modal id= "`example-modal-${item}`" size="xl" title="Noticia">
          <b-card-text>
